            ...
            <div className="col-span-full">
              ...
              <div className="mt-2">
                <textarea
                  ...
                  rows={3}
                  className="block w-full px-1 rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset "
                  defaultValue={''}
                />
              </div>
